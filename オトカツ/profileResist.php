...
if(isset($getDBUserdata['username'])){
...
if(!empty($_POST)){
  ...
  //画像をアップロードしてるときパスを格納
  $pic=(!empty($_FILES["pic"]["name"])) ? uploadImg($_FILES['pic'],'pic'):"pic\sample-img.png";
...
<div class="profileEdit-main-wrapper main-wrapper">
  ...
  <section class="profile-edit">
    ...
    <div class="profile-edit-wrapper">
      ...
      <p>プロフィール</p>
      <textarea name="profile" class="profile <?php addErrClass('profile');?>" rows="10"><?php showDBdata("profile"); ?></textarea>
