  ...
  if(empty($err_msg)){
    ...
    try{
      ...
      if($edit_flg){
        ...
        //プレースホルダー
      $data=array(':name'=>$artist_name,':category_id'=>$category,':profile'=>$profile,':pic'=>$pic,':artist_id'=>$artist_id);
      }else{
      ...
      debug('insertid::'.print_r($id,true));
...
<div class="resistArtist-main-wrapper main-wrapper">
  ...
  <section class="profile-edit">
    ...
    <div class="profile-edit-wrapper">
      ...
      <p>アーティスト名</p>
      <input type="text" name="artist_name" value="<?php showDBdata("artist_name");?>" class="<?php addErrClass('artist_name');?>">
      ...
      <p>プロフィール</p>
      <textarea name="profile" class="profile" rows="10" value="<?php showDBdata("profile")?>"></textarea>
